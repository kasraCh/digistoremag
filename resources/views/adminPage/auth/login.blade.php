        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
                <div class="flex-row text-center mx-auto">
                    ...
                    <div class="mx-auto">
                        <h3>به صفحه مدیریت دیجی مگ خوش امدید</h3>
                        <p>
                            <br>
                            مقاله های خود در دسته بندی های مورد نظر خود پخش کنید و دیگران را ار پخش ان مطلع کنید .
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-5 p-4">
                <div class="w-px-400 mx-auto">
                    ...
                    <div class="app-brand mb-4">
                        <p class="app-brand-link gap-2 mb-2">
                            ...
                            <a href="{{ route('digimag.index') }}">
                                <span class="app-brand-text demo h3 mb-0 fw-bold">دیجی مگ</span>
                            </a>
                        </p>
                    </div>
                    <!-- /Logo -->
                    <h4 class="mb-3 secondary-font">به دیجی مگ خوش آمدید!</h4>
                    ...
                    <form id="formAuthentication" class="mb-3" action="{{ route('admin.login.action') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control text-start" id="email" name="email"
                                placeholder="ایمیل یا نام کاربری خود را وارد کنید" autofocus dir="ltr">
                        </div>
...
@section('vendors-script')
    ...
    <!-- Page JS -->
    <script src="{{ asset('admin-page/assets/js/pages-auth.js') }}"></script>
    <script type="text/javascript" src="{{ url('vendor/jsvalidation/js/jsvalidation.js') }}"></script>
    {!! JsValidator::formRequest('App\Http\Requests\Auth\UserLoginRequest') !!}
@endsection
