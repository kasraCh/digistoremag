...
@section('vendors-css')
    ...
    <link rel="stylesheet" href="{{ asset('admin-page/assets/vendor/libs/apex-charts/apex-charts.css') }}">
@endsection
                ...
                <div class="card h-100">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center me-3">
                            <img src="{{ asset('admin-page/assets/img/avatars/4.png') }}" alt="آواتار"
                    ...
                    <div class="card-body">
                            ...
                            <div class="d-flex flex-column me-2">
                                ...
                                <ul class="list-unstyled me-2 d-flex align-items-center avatar-group mb-0">
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="تونی استارک" class="avatar avatar-xs pull-up">
                                        <img class="rounded-circle"
                                            src="{{ asset('admin-page/assets/img/avatars/5.png') }}" alt="آواتار">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="استیو راجرز" class="avatar avatar-xs pull-up">
                                        <img class="rounded-circle"
                                            src="{{ asset('admin-page/assets/img/avatars/12.png') }}" alt="آواتار">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="بری الن" class="avatar avatar-xs pull-up">
                                        <img class="rounded-circle"
                                            src="{{ asset('admin-page/assets/img/avatars/6.png') }}" alt="آواتار">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="دیوید بکهام" class="avatar avatar-xs pull-up">
                                        <img class="rounded-circle"
                                            src="{{ asset('admin-page/assets/img/avatars/14.png') }}" alt="آواتار">
                                    </li>
                                    <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                        title="جسیکا آلبا" class="avatar avatar-xs pull-up">
                                        <img class="rounded-circle"
                                            src="{{ asset('admin-page/assets/img/avatars/10.png') }}" alt="آواتار">
                                    </li>
                                </ul>
                            </div>
                            <div class="d-flex flex-column me-2">
                        ...
                        <span class="lh-1-85">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از
                            طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در</span>
                    </div>
                                ...
                                <div class="timeline-event pb-2">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center">
                                        <div class="avatar me-3 mt-1">
                                            <img src="{{ asset('admin-page/assets/img/avatars/1.png') }}" alt="آواتار"
                                ...
                                <div class="timeline-event pb-0">
                                    ...
                                    <div class="d-flex align-items-center avatar-group">
                                        <div class="avatar avatar-sm pull-up" data-bs-toggle="tooltip"
                                            data-popup="tooltip-custom" data-bs-placement="top" title="تونی استارک">
                                            <img src="{{ asset('admin-page/assets/img/avatars/5.png') }}" alt="آواتار"
                                                class="rounded-circle">
                                        </div>
                                        <div class="avatar avatar-sm pull-up" data-bs-toggle="tooltip"
                                            data-popup="tooltip-custom" data-bs-placement="top" title="بیل گیتس">
                                            <img src="{{ asset('admin-page/assets/img/avatars/12.png') }}" alt="آواتار"
                                                class="rounded-circle">
                                        </div>
                                        <div class="avatar avatar-sm pull-up" data-bs-toggle="tooltip"
                                            data-popup="tooltip-custom" data-bs-placement="top" title="پیتر پارکر">
                                            <img src="{{ asset('admin-page/assets/img/avatars/9.png') }}" alt="آواتار"
                                                class="rounded-circle">
                                        </div>
                                        <div class="avatar avatar-sm pull-up" data-bs-toggle="tooltip"
                                            data-popup="tooltip-custom" data-bs-placement="top" title="بروس وین">
                                            <img src="{{ asset('admin-page/assets/img/avatars/6.png') }}" alt="آواتار"
                                                class="rounded-circle">
                                        </div>
                                        <div class="avatar avatar-sm pull-up" data-bs-toggle="tooltip"
                                            data-popup="tooltip-custom" data-bs-placement="top" title="اولیور کویین">
                                            <img src="{{ asset('admin-page/assets/img/avatars/14.png') }}" alt="آواتار"
                                                class="rounded-circle">
                                        </div>
                                    </div>
                                </div>
...
@section('vendors-script')
    <!-- Vendors JS -->
    <script src="{{ asset('admin-page/assets/vendor/libs/apex-charts/apexcharts.js') }}"></script>

    <!-- Page JS -->
    <script src="{{ asset('admin-page/assets/js/dashboards-analytics.js') }}"></script>
@endsection
